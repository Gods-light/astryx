import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{n as r,t as i}from"./themeProps-_oSbOSxB.js";import{E as a,t as o,x as s}from"./utils-BlVT_diJ.js";import{t as c}from"./jsx-runtime-DqZldVDK.js";import{n as l}from"./useTooltip-CdbL6YrA.js";import{r as u,t as d}from"./i18n-TdjuutMd.js";import{t as f}from"./Tooltip-B1rE8XDl.js";import{n as p,t as m}from"./Field-EGL2_6yA.js";import{a as h,i as g,n as _,o as v,r as y,t as b}from"./ListItem-CU6A1f9X.js";import{i as x,n as S,r as C,t as w}from"./CheckboxInput-CqtTXn2t.js";function T({label:e,isLabelHidden:t=!1,description:n,status:i,value:o,onChange:s,changeAction:c,density:u=`balanced`,hasDividers:d=!1,isDisabled:f=!1,disabledMessage:p,isReadOnly:h=!1,children:g,ref:_,width:v,xstyle:b,className:x,style:S,"data-testid":w,...T}){let k=(0,E.useId)(),A=(0,E.useId)(),j=(0,E.useId)(),M=(0,E.useId)(),[,N]=(0,E.useTransition)(),P=o!==void 0,[F,I]=(0,E.useOptimistic)(o??O),[L,R]=(0,E.useOptimistic)(null),z=f&&!!p,B=l({placement:`above`,focusTrigger:`always`,isEnabled:z}),V=(0,E.useCallback)((e,t)=>{s?.(e),c&&N(async()=>{I(e),t!==void 0&&R(t),await c(e)})},[s,c,N,I,R]),H=(0,E.useMemo)(()=>({value:P?F:void 0,onChange:P?V:void 0,isDisabled:f,hasDisabledMessage:z,isReadOnly:h,loadingValue:L}),[P,F,V,f,z,h,L]);return(0,D.jsxs)(m,{...T,ref:_,"data-testid":w,label:e,isLabelHidden:t,description:n,inputID:k,labelID:A,isGroupLabel:!0,descriptionID:n?j:void 0,isDisabled:f,status:i?{type:i.type,message:i.message,messageID:i.message?M:void 0}:void 0,statusVariant:`detached`,width:v,xstyle:b,...a(r(`checkbox-list`),{className:x,style:S}),children:[(0,D.jsx)(C,{value:H,children:(0,D.jsx)(`div`,{ref:e=>{B.ref(e)},role:`group`,"aria-labelledby":A,"aria-describedby":[n?j:null,i?.message?M:null,z?B.describedBy:null].filter(Boolean).join(` `)||void 0,children:(0,D.jsx)(y,{density:u,hasDividers:d,children:g})})}),z&&B.renderTooltip(p)]})}var E,D,O,k=e((()=>{E=t(n(),1),p(),g(),f(),o(),i(),x(),D=c(),O=[],T.displayName=`CheckboxList`,T.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function A({label:e,value:t,description:n,endContent:r,isDisabled:i=!1,isLoading:a=!1,isChecked:o,onCheck:c,ref:l,xstyle:d,className:f,style:p,onClick:m,...g}){let _=u(),v=(0,j.use)(C);if(v&&v.value!==void 0&&t===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let y=((0,j.use)(h)?.density??`balanced`)===`compact`?`sm`:`md`,x=(v?.isDisabled??!1)||i,S=v?.isReadOnly??!1,T=a||(v?.loadingValue!=null&&t!==void 0?v.loadingValue===t:!1),E=!1;v&&v.value!==void 0&&t!==void 0?E=v.value.includes(t):o!==void 0&&(E=o);let D=!S&&(v!=null||c!=null),O=()=>{x||S||T||(v&&v.value!==void 0&&t!==void 0?v.value.includes(t)?v.onChange?.(v.value.filter(e=>e!==t),t):v.onChange?.([...v.value,t],t):c?.(E!==!0))};return(0,M.jsx)(b,{...g,ref:l,label:e,description:n,endContent:r,isDisabled:x,onClick:D||m?s(m,D?O:void 0):void 0,"aria-busy":T||void 0,xstyle:[E===!0&&!x&&!S&&N.selected,d],className:f,style:p,startContent:(0,M.jsx)(w,{label:typeof e==`string`?e:_(`@astryx.checkboxList.item.checkbox`),isLabelHidden:!0,value:E,onChange:()=>O(),isDisabled:x,isReadOnly:S,isLoading:T,size:y})})}var j,M,N,P=e((()=>{j=t(n(),1),o(),S(),_(),v(),x(),d(),M=c(),N={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},A.displayName=`CheckboxListItem`,A.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
