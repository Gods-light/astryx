import{i as e}from"./preload-helper-CT_b8DTk.js";import{i as t,t as n}from"./CodeBlock-Bgx2Tm0h.js";var r,i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{n(),r={title:`Core/CodeBlock`,component:t,tags:[`autodocs`],argTypes:{language:{control:`select`,options:[`typescript`,`javascript`,`json`,`html`,`css`,`python`,`bash`,`php`,`hack`,`yaml`,`markdown`,`plaintext`],description:`Language for syntax highlighting`},size:{control:`select`,options:[`sm`,`md`],description:`Text size`},width:{control:`text`,description:`Width of the code block (any CSS width value)`},container:{control:`select`,options:[`card`,`section`],description:`Container presentation style`},hasLineNumbers:{control:`boolean`},hasStickyLineNumbers:{control:`boolean`},hasCopyButton:{control:`boolean`},isWrapped:{control:`boolean`}}},i=`import {useState, useEffect} from 'react';
...
const result = someVeryLongFunctionName(parameterOne, parameterTwo, parameterThree, parameterFour, parameterFive);`,language:`typescript`,isWrapped:!0,hasLineNumbers:!0}},m={args:{code:`const requestConfiguration = createRequestConfiguration({authenticationStrategy: 'service-token', retryAttempts: 3, timeoutMilliseconds: 30000});
const response = await executeRequest(requestConfiguration);`,language:`typescript`,title:`request.ts`,hasLineNumbers:!0,hasStickyLineNumbers:!0,width:`100%`}},h={args:{code:`const requestConfiguration = createRequestConfiguration({authenticationStrategy: 'service-token', retryAttempts: 3, timeoutMilliseconds: 30000, headers: {'x-client-version': applicationVersion}});
...
return normalizeServiceResponse(response, {includeMetadata: true, preserveHeaders: false, deserializeDates: true});`,language:`typescript`,title:`wrapped-request.ts`,hasLineNumbers:!0,hasStickyLineNumbers:!0,isWrapped:!0,highlightLines:[2],width:`100%`}},g={args:{code:Array.from({length:50},(e,t)=>`const line${t+1} = ${t+1};`).join(`
`),language:`typescript`,title:`many-lines.ts`,hasLineNumbers:!0,maxHeight:200}},_={args:{code:i,language:`typescript`,title:`useUser.ts`,hasLineNumbers:!0,size:`sm`}},v={args:{code:`const greeting = "Hello, world!";
console.log(greeting);`,language:`typescript`,hasCopyButton:!0}},y={args:{code:`This is plain text without any syntax highlighting.
It preserves whitespace and line breaks.

  Indentation is maintained.
    Nested indentation too.`,language:`plaintext`,title:`notes.txt`,hasLineNumbers:!0}},b={args:{code:i,language:`typescript`,title:`useUser.ts`,width:`100%`}},x={args:{code:i,language:`typescript`,title:`useUser.ts`,width:`100%`,container:`section`}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    code: tsExample,
    language: 'typescript',
    title: 'useUser.ts',
...
}`,...x.parameters?.docs?.source}}},S=[`Default`,`WithHighlightedLines`,`JSON`,`Python`,`HTML`,`CSS`,`Bash`,`SingleLine`,`Wrapped`,`StickyLineNumbers`,`StickyLineNumbersWrapped`,`WithMaxHeight`,`SmallSize`,`NoHeader`,`Plaintext`,`FullWidth`,`ContainerSection`]}))();export{d as Bash,u as CSS,x as ContainerSection,a as Default,b as FullWidth,l as HTML,s as JSON,v as NoHeader,y as Plaintext,c as Python,f as SingleLine,_ as SmallSize,m as StickyLineNumbers,h as StickyLineNumbersWrapped,o as WithHighlightedLines,g as WithMaxHeight,p as Wrapped,S as __namedExportsOrder,r as default};