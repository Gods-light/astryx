...
@default false`,defaultValue:{value:`false`,computed:!1}},width:{required:!1,tsType:{name:`union`,raw:`number | string`,elements:[{name:`number`},{name:`string`}]},description:"Width of the field. Numbers are treated as pixels, strings are used as-is\n(e.g. `'100%'`). Sizes the whole field (label, control, and status) so they\nstay aligned, unlike setting width via `xstyle`/`className`/`style`."},children:{required:!0,tsType:{name:`ReactNode`},description:`Checkbox list items to render.`}},composes:[`Omit`]}}));function A({label:e,"aria-label":t,value:n,description:r,endContent:i,isDisabled:a=!1,isLoading:s=!1,isChecked:c,onCheck:l,ref:d,xstyle:f,className:p,style:m,onClick:g,..._}){let v=u(),y=(0,j.use)(C);if(y&&y.value!==void 0&&n===void 0)throw Error("CheckboxListItem requires a `value` prop when used inside CheckboxList with a value array.");let x=t??(typeof e==`string`?e:v(`@astryx.checkboxList.item.checkbox`)),S=(0,j.useRef)(!1);(0,j.useEffect)(()=>{typeof e!=`string`&&t==null&&!S.current&&(S.current=!0,console.warn('CheckboxListItem: `label` is a ReactNode, so the checkbox falls back to the generic accessible name "Checkbox". Pass `aria-label` with a concise string equivalent of the visible label so screen readers can tell items apart.'))},[e,t]);let T=((0,j.use)(h)?.density??`balanced`)===`compact`?`sm`:`md`,E=(y?.isDisabled??!1)||a,D=y?.isReadOnly??!1,O=s||(y?.loadingValue!=null&&n!==void 0?y.loadingValue===n:!1),k=!1;y&&y.value!==void 0&&n!==void 0?k=y.value.includes(n):c!==void 0&&(k=c);let A=!D&&(y!=null||l!=null),P=()=>{E||D||O||(y&&y.value!==void 0&&n!==void 0?y.value.includes(n)?y.onChange?.(y.value.filter(e=>e!==n),n):y.onChange?.([...y.value,n],n):l?.(k!==!0))};return(0,M.jsx)(b,{..._,ref:d,label:e,description:r,endContent:i,isDisabled:E,onClick:A||g?o(g,A?P:void 0):void 0,"aria-busy":O||void 0,xstyle:[k===!0&&!E&&!D&&N.selected,f],className:p,style:m,startContent:(0,M.jsx)(w,{label:x,isLabelHidden:!0,value:k,onChange:()=>P(),isDisabled:E,isReadOnly:D,isLoading:O,size:T})})}var j,M,N,P=e((()=>{j=t(n(),1),s(),S(),_(),v(),x(),d(),M=c(),N={selected:{kWkggS:`astryxgcxg3y`,$$css:!0}},A.displayName=`CheckboxListItem`,A.__docgenInfo={description:`A checkbox item for use within CheckboxList (collection mode)
