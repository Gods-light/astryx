...
// self-contained — the previous cross-origin CDN URLs no longer resolve,
// which left the Thumbnails showing their placeholder fallback instead of
// a photo behind the remove button. Scenes are shared with the Thumbnail
// examples and span a luminance ramp so the fixed white-on-scrim remove
// button reads correctly on each.
const NIGHT_FOREST =
...
const IMAGE_ATTACHMENTS = [
  ...
  },
  {
    id: '5',
    src: NIGHT_FOREST,
    alt: 'River through a valley at dusk',
    label: 'lakeside.jpg',
  },
];
